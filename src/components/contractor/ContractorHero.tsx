        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <button 
              ...
              className="bg-white text-era-navy px-10 py-5 text-sm font-bold uppercase tracking-[0.2em] rounded-none hover:bg-era-ivory transition-all shadow-xl shadow-white/5"
            >
              Meld interesse
            </button>
